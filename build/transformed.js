...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__containers_AppContainer__ = __webpack_require__(27);
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__containers_AppContainer__["a" /* default */], null), appRoot);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_NewGame__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Colors__ = __webpack_require__(30);
...
class AppContainer extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  constructor(props) {
    super(props);

    this.state = {
      guessColor: "RGB(1, 200, 30)",
      newgame: false,
      difficulty: "easy",
  ...
  render() {
    const { changeDifficulty, difficulty } = this.state;
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "div",
      null,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_Header__["a" /* default */], { guessColor: guessColor }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_NewGame__["a" /* default */], { changeDifficulty: changeDifficulty, difficulty: difficulty }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_Colors__["a" /* default */], { colors: colors })
    );
  }
}
...
const NewGame = ({ difficulty, changeDifficulty }) => {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "div",
    { className: "newgame-container" },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "div",
      { onClick: () => alert("new game started!"), className: "newgame" },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "p",
        null,
        "NEW COLORS"
...
const Colors = ({ colors }) => {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "div",
    { className: "allcolors-container" },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Color__["a" /* default */], { color: colors[0] }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Color__["a" /* default */], { color: colors[1] }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Color__["a" /* default */], { color: colors[2] }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Color__["a" /* default */], { color: colors[3] }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Color__["a" /* default */], { color: colors[4] }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Color__["a" /* default */], { color: colors[5] })
  );
};
